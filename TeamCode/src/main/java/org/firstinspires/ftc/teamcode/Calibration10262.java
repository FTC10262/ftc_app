...
public class Calibration10262 extends ConstantsBase {
    ...
    public static double TRAY_PINCH_OPEN = 0.26;
    public static double TRAY_PINCH_WIDE_OPEN = 0.2;
    ...
    public static double GEM_DRIVE_DURATION = 0.7;

    public static double AUTON_DRIVE_RAMP_TIME = 1;
    public static double AUTON_DRIVE_SPEED = 1;
    ...
    public static double JEWEL_KICK_CENTER = 0.5;
